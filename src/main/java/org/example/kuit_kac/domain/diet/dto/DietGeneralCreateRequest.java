...
public record DietGeneralCreateRequest(
    ...
    @Schema(description = "식단 항목 종류(기록, 계획, AI 계획)", example = "기록", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    List<@Valid DietFoodGeneralCreateRequest> foods
) {} 