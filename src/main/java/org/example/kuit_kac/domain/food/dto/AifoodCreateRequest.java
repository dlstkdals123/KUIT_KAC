...
public record AifoodCreateRequest(
    ...
    @Schema(description = "칼로리", example = "200.0")
    @NotNull(message = "칼로리는 필수입니다")
    @JsonProperty("kcal")
    Double kcal,
    
    @Schema(description = "탄수화물", example = "40.0")
    @NotNull(message = "탄수화물은 필수입니다")
    @JsonProperty("carb")
    Double carb,
    
    @Schema(description = "단백질", example = "6.0")
    @NotNull(message = "단백질은 필수입니다")
    @JsonProperty("protein")
    Double protein,
    
    @Schema(description = "지방", example = "1.0")
    @NotNull(message = "지방은 필수입니다")
    @JsonProperty("fat")
    Double fat,
    
    @Schema(description = "당류", example = "5.0")
