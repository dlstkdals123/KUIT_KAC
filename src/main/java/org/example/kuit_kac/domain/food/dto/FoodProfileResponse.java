...
public class FoodProfileResponse {
    ...
    @Schema(description = "음식의 단위 타입", example = "개", requiredMode = Schema.RequiredMode.REQUIRED)
    private String unitType;

    @Schema(description = "음식의 타입", example = "NORMAL_FRUIT", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "음식의 칼로리", example = "100.0", requiredMode = Schema.RequiredMode.REQUIRED)
